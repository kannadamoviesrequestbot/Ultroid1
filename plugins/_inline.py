...
SUP_BUTTONS = [
    [
        Button.url("channel", url="https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17"),
        Button.url("Group", url="https://t.me/searchkannadamovies"),
    ],
    [Button.url("Support", url="t.me/BAGURUJOINAGUUKANNADAMOVIES_17")],
]
